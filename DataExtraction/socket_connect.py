...
connections = [
    {
        ...
        "message": {"op": "subscribe",
                    "args": ["instrument:CONTRACTS", "liquidation", "orderBookL2_25:ETHUSD", "trade:ETHUSD"]},
        "tag": "eth"
    },
    {
        "uri": "wss://www.bitmex.com/realtimeWeb?heartbeat=1&_primuscb=O-Xl4mj",
        "message": {"op": "subscribe",
                    "args": ["instrument:CONTRACTS", "liquidation", "orderBookL2_25:XBTUSD", "trade:XBTUSD"]},
        "tag": "btc"
    },
    {
        "uri": "wss://www.bitmex.com/realtimeWeb?heartbeat=1&_primuscb=O-XqRXG",
        "message": {"op": "subscribe",
                    "args": ["instrument:CONTRACTS", "liquidation", "orderBookL2_25:SOLUSD", "trade:SOLUSD"]},
        "tag": "sol"
    },
    {
